/* LifeOS SW: app-shell cache + Today/7-day cache + offline fallback + queue replay hint. */
...
self.addEventListener("push", (e) => {
  ...
  e.waitUntil(self.registration.showNotification(data.title, { body: data.body, tag: "lifeos" }));
});
