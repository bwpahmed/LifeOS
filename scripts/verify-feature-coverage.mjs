...
const checks=[
 ...
 ["AE Password recovery",has("app/login/page.tsx","resetPasswordForEmail","Reset password","lifeos_auth_mode","location.origin+\"/\"")&&exists("app/auth/update-password/page.tsx")&&has("app/auth/update-password/page.tsx","updateUser({password})","passwordMeetsLifeOSPolicy")&&has("app/page.tsx","PASSWORD_RECOVERY","exchangeCodeForSession","lifeos_auth_next","Opening LifeOS")&&has("app/auth/callback/route.ts","supabaseServer","safeNextPath")],
