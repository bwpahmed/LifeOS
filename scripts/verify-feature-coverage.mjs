...
const checks=[
 ...
 ["AE Password recovery",has("app/login/page.tsx","resetPasswordForEmail","Reset password")&&exists("app/auth/update-password/page.tsx")&&has("app/auth/update-password/page.tsx","updateUser({password})","passwordMeetsLifeOSPolicy")&&has("app/auth/callback/route.ts","supabaseServer","safeNextPath")],
