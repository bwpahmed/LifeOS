...
export default function Home(){
 ...
 return <main className="page-root pt-6"><div className="flex flex-wrap items-start justify-between gap-3"><div><p className="text-[11px] tracking-[1.45px] text-slate-400">LIFEOS · {today}</p><h1 className="text-3xl font-extrabold tracking-tight">{greeting}</h1><p className="mt-2 max-w-2xl text-sm text-slate-400">Right thing. Right time. Consistently.</p></div><div className="flex gap-2"><Link href="/search" className="rounded-lg border border-white/10 px-3 py-2 text-sm">Search</Link><Link href="/notifications" className="rounded-lg border border-white/10 px-3 py-2 text-sm">Alerts</Link><Link href="/login" className="rounded-lg border border-white/10 px-3 py-2 text-sm text-[#9fc4ff]">Account</Link></div></div>
