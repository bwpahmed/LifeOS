...
Load and follow the pinned upstream capability at `.agents/vendor/agentmemory/skills/handoff/SKILL.md` only when relevant to the current task. Inspect any references/scripts in that vendor subtree before using them. Do not create parallel project logic or bypass repository safety rules.
