...
`"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run parse_html.py` classifies each image's lazy-loading mechanism via the
...
"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run iptc_ai_label.py audit ./images/ --json

# Audit a single image
"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run iptc_ai_label.py audit ./hero.webp --json

# Inject the AI label into an image
"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run iptc_ai_label.py inject ./ai-hero.webp \
