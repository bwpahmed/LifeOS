...
- `"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run drift_baseline.py <url>` -- capture a new baseline
- `"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run drift_compare.py <url>` -- compare current state to baseline
- `"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run drift_history.py <url>` -- show change history
- `"$(git rev-parse --show-toplevel)/.agents/vendor/claude-seo/scripts/claude-seo" run drift_report.py <file> --output report.html` -- generate HTML report
